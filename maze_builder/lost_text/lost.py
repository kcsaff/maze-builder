...
lost_sentence = MadLibs({
    ...
    IM_GOING_IN_CIRCLES={
        "{IM_GOING_IN_CIRCLES_UNFIXED FIXED}": 3,
        "{IM_GOING_IN_CIRCLES_UNFIXED FIXED STRUCK}": 1,
    },
    IM_GOING_IN_CIRCLES_UNFIXED={
        "Am I {GOING} in circles?": 2,
        "I'm {GOING} in circles!": 3,
        "How many times have I been here?": 2,
        "Not this place again!": 2,
        "This place again!": 2,
        "Here again?": 2,
        "Will I choose better this time?": 1,
        "Choose better this time!": 1,
        "I've tried every exit!": 2,
        "I always end up back here.": 1,
        "Gotta stop taking the same exit here.": 1,
        "Why even bother leaving this room?": 1,
    },
    ALREADY={
        'already': 10,
        'before': 10,
    ...
    SENTENCE={
        ...
        "Can't I just start over?": 1,
        "I made a wrong turn {A_LONG_TIME_AGO}.": 1,
        "Did I go the right way {A_LONG_TIME_AGO}?": 1,
        "{MARKS} from the last time I was here.": 1,
        "This {ITEM} means I've been here {ALREADY}.": 1,
        "These {ITEMS} suggest I've been here {ALREADY}.": 1,
        "Is this my {ITEM}? {IM_GOING_IN_CIRCLES FIXED}": 2,
        "Are these my {ITEMS}? {IM_GOING_IN_CIRCLES}": 2,
    }
)
